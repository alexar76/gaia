...
ALLOWED_HOSTS = frozenset({
    ...
    # P5 (licence-pinned — see live_p5.py)
    ...
    "api.nasa.gov",
    # P6 (commercially clear — see live_p6.py)
    "ddapi20-waterwebservices.rijkswaterstaat.nl",
    "cwms-data.usace.army.mil",
    "data.epa.gov",
    "www.met.ie",
    "opendata2.met.ie",
    # P7 (Scandinavia weather + UK rivers — see live_p7.py)
    "frost.met.no",
    "opendataapi.dmi.dk",
    "timeseries.sepa.org.uk",
    "api.naturalresources.wales",
    # P8 (INGV quake + CDIP waves + ICOS GHG — see live_p8.py)
    "webservices.ingv.it",
    "erddap.cdip.ucsd.edu",
    "meta.icos-cp.eu",
    "data.icos-cp.eu",
    "cpauth.icos-cp.eu",
    # P9 (Hub'Eau FR + eHYD AT + SMHI MetObs — see live_p9.py)
    "hubeau.eaufrance.fr",
    "gis.lfrz.gv.at",
    "opendata-download-metobs.smhi.se",
    # P10 (Singapore NEA + HKO + IRCELINE — see live_p10.py)
    "api.data.gov.sg",
    "data.weather.gov.hk",
    "geo.irceline.be",
    # P11 (AEMET / MeteoSwiss / BAFU / CWA / DPObs / EE / IS / HK AQHI)
    "opendata.aemet.es",
    "data.geo.admin.ch",
    ...
    # P12 (GeoSphere / LHMT / LVGMC / VIC / RTE / OPW / JMA / INMET / CHMU / KMA / GFM)
