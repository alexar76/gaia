...
class LiveDevice(VirtualDevice):
    ...
    # Every relay, whatever its sample(), is refused by VirtualDevice.read when it brings
    # no observation: every om-aq-* relay once signed {} against a self-hosted Open-Meteo
    # that synced no air-quality model, and a dozen overrides copied the same filter.
