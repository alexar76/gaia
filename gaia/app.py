...
_READ_CAP_BY_TYPE = {
    ...
    # P5
    "PegelonlineRiver": "gaia.river.read@v1",
    "AviationMetar": "gaia.aviation.read@v1",
    "DigitrafficRoadWeather": "gaia.road.read@v1",
    "DigitrafficRail": "gaia.rail.read@v1",
    "UsDroughtMonitor": "gaia.drought.read@v1",
    "GeoShakeQuake": "gaia.quake.read@v1",
    "NaadAlerts": "gaia.alerts.read@v1",
    "SwpcSolarWind": "gaia.spacewx.read@v1",
    "SwpcGoesXray": "gaia.spacewx.read@v1",
    "NasaDonki": "gaia.spacewx.read@v1",
    # P6
    "EaHydrologyRiver": "gaia.river.read@v1",
    "RwsRiver": "gaia.river.read@v1",
    "UsaceReservoir": "gaia.reservoir.read@v1",
    "EpaUvIndex": "gaia.uv.read@v1",
    "MetEireannObs": "gaia.weather.read@v1",
    # P7
    "MetNorwayFrost": "gaia.weather.read@v1",
    "DmiMetObs": "gaia.weather.read@v1",
    "SepaRiver": "gaia.river.read@v1",
    "NrwRiver": "gaia.river.read@v1",
    # P8
    "IngvQuake": "gaia.quake.read@v1",
    "CdipWave": "gaia.marine.read@v1",
    "IcosGhg": "gaia.ghg.read@v1",
    # P9
    "HubEauRiver": "gaia.river.read@v1",
    "EhydRiver": "gaia.river.read@v1",
    "SmhiMetObs": "gaia.weather.read@v1",
    # P10
    "SgNeaWeather": "gaia.weather.read@v1",
    "SgNeaPsiAir": "gaia.air.read@v1",
    "HkoWeather": "gaia.weather.read@v1",
    "IrcelineAir": "gaia.air.read@v1",
    # P11
    "AemetWeather": "gaia.weather.read@v1",
    "MeteoSwissWeather": "gaia.weather.read@v1",
    "BafuRiver": "gaia.river.read@v1",
    "CwaWeather": "gaia.weather.read@v1",
    "MeteoFranceWeather": "gaia.weather.read@v1",
    "EstoniaWeather": "gaia.weather.read@v1",
    "IcelandWeather": "gaia.weather.read@v1",
    "HkAqhiAir": "gaia.air.read@v1",
    # P12
    "GeosphereWeather": "gaia.weather.read@v1",
    "LhmtWeather": "gaia.weather.read@v1",
    "LhmtRiver": "gaia.river.read@v1",
    "LvgmcWeather": "gaia.weather.read@v1",
    "LvgmcRiver": "gaia.river.read@v1",
    "VicFlood": "gaia.flood.read@v1",
    "RteGrid": "gaia.grid.read@v1",
    "OpwRiver": "gaia.river.read@v1",
    "JmaAmedasWeather": "gaia.weather.read@v1",
    "JmaQuake": "gaia.quake.read@v1",
    "JmaTyphoon": "gaia.cyclone.read@v1",
    "InmetWeather": "gaia.weather.read@v1",
    "ChmuWeather": "gaia.weather.read@v1",
    "KmaAsosWeather": "gaia.weather.read@v1",
    "GfmFlood": "gaia.flood.read@v1",
}
...
def build_app(runtime: GatewayRuntime | None = None,
    ...
    # Fail closed. The default was "*", which let any page on the internet read a
    # device's readings from a visitor's browser — and, once that visitor held a key,
    # spend their allowance. Both deployments (gaia/docker-compose.yml and
    # docker-compose.everything.yml) already pass a real allowlist, so this only bites a
    # bare `python -m gaia`, where the answer is to name the origin you actually serve.
    # Server-to-server callers (ATLAS, the hub) never send Origin and are unaffected.
