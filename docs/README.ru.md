...
<p align="center">
  <a href="https://iot.modelmarket.dev/">
    <img src="assets/hero.svg" alt="GAIA — показание уходит с физической площадки, подписывается на источнике ключом Ed25519, продаётся как возможность AIMarket v2 и рассчитывается через /v1/verify: правдоподобное платит провайдеру, неправдоподобное возвращает деньги покупателю" width="100%" />
  </a>
</p>
...
| `openaq-01` | `gaia.air.read@v1` | OpenAQ v3 | **да — бесплатный** ключ с [explore.openaq.org](https://explore.openaq.org) → `GAIA_OPENAQ_API_KEY` |
