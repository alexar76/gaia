...
<!-- aicom-readme-badges -->
<p align="center">
  <a href="https://github.com/alexar76/gaia/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/alexar76/gaia/ci.yml?branch=main&label=CI" alt="CI" /></a>
  <a href="https://github.com/alexar76/gaia/actions/workflows/pages.yml"><img src="https://img.shields.io/github/actions/workflow/status/alexar76/gaia/pages.yml?branch=main&label=Pages" alt="Pages deploy" /></a>
  <a href="https://iot.modelmarket.dev/"><img src="https://img.shields.io/website?url=https%3A%2F%2Fiot.modelmarket.dev&up_message=live&up_color=brightgreen&down_message=down&down_color=red&label=demo" alt="Live demo status" /></a>
  <a href="https://alexar76.github.io/gaia/"><img src="https://img.shields.io/badge/landing-earth-2dd4a8" alt="Landing" /></a>
  <a href="https://github.com/alexar76/gaia/pkgs/container/gaia"><img src="https://img.shields.io/badge/ghcr-gaia-2dd4a8" alt="GHCR package" /></a>
  <img src="https://img.shields.io/badge/python-%3E%3D3.11-brightgreen.svg" alt="Python >=3.11" />
  <img src="https://img.shields.io/badge/AIMarket-v2-0a4a3c" alt="AIMarket v2" />
  <img src="https://img.shields.io/badge/signing-Ed25519-blue" alt="Ed25519 signing" />
